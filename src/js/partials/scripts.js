// lazy-loading images new approach
...
function initOutdoor ()
{
    ...
    function initGalleryhorizontal ()
    {
        ...
        e.find(".item > picture").css("height", a - c - d);
...
function initDefer ()
{
    ...
    for (var i = 0; i < imgDefer.length; i++)
    {
        ...
        {
            console.log('lazy-loading ' + imgDefer[i].getAttribute('data-src'));
    ...
    for (var j = 0; j < sourceDefer.length; j++)
    {
        ...
        {
            console.log('lazy-loading ' + sourceDefer[j].getAttribute('data-src'));
            sourceDefer[j].setAttribute('srcset', sourceDefer[j].getAttribute('data-src'));
        }
    }
}
